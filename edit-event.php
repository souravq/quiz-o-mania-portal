...
$fetchData=$obj->select_all_where('event','where event_id  ="'.$event_id.'"');
      ...
      $event_start_time = $values['event_start_time'];
       $event_end_time = $values['event_end_time'];
        $event_place = $values['event_place'];
         $event_expense = $values['event_expense'];
          $event_expense_details = $values['event_expense_details'];
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                       <form id="update_event_form" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="eventInput1" class="form-control" name="update_event_name" placeholder="Enter Event Name" value="<?= $event_name ?>" required>
                                                            <input type="hidden" name="event_id" value=<?= $event_id ?>>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="eventInput2">Event Date<span style="color:red; font-size:20px;">*</span> </label>
                                                            <input type="date" id="eventInput2" class="form-control" name="update_event_date" placeholder="Enter date" value="<?= $event_date ?>" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput3">Event Start Time</label>
                                                            <input type="text" id="eventInput3" class="form-control" placeholder="Enter Event Start Time" name="event_start_time" value="<?= $event_start_time ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="eventInput4">Event End Time</label>
                                                            <input type="text" id="eventInput4" class="form-control" placeholder="Enter Event End Time" name="event_end_time" value="<?= $event_end_time ?>">
                                                        </div>
                                                        <div class="form-group">
                                                        
                                                            <label for="eventInput5">Event Place</label>
                                                            <input type="text" id="eventInput5" class="form-control" name="event_place" placeholder="Enter Event Place" value="<?= $event_place ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput6">Event Expense</label>
                                                            <input type="text" id="eventInput6" class="form-control" placeholder="Enter Event Expense" name="event_expense" value="<?= $event_expense ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput7">Event Expense Details</label>
                                                            <input type="text" id="eventInput7" class="form-control" placeholder="Enter Event Expense Details" name="event_expense_details" value="<?= $event_expense_details ?>">
                                                        </div>
