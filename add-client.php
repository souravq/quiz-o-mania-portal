...
<?php 
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Add Client</h3>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                       <form id="add_client_form" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div >
                                                                <select id="branch_name" name="branch_name" class="form-control" required>
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo $namevalue['branch_name']; ?>"><?php echo $namevalue['branch_name']; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="eventInput1" class="form-control" placeholder="Enter name" name="client_name" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput2"> Company<span style="color:red; font-size:20px;">*</span></label>
                                                            <input type="text" id="eventInput2" class="form-control" placeholder="Enter Company Name" name="client_company_name" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput3"> Email ID<span style="color:red; font-size:20px;">*</span></label>
                                                            <input type="email" id="eventInput3" class="form-control" placeholder="Enter Email Id" name="client_email" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput4">Phone No.<span style="color:red; font-size:20px;">*</span></label>
                                                            <input type="text" id="eventInput4" class="form-control" placeholder="Enter Phone Number" name="client_phone_number" pattern="[6789][0-9]{9}" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput5">Address<span style="color:red; font-size:20px;">*</span></label>
                                                            <input type="text" id="eventInput5" class="form-control" placeholder="Enter Address" name="client_address" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput6">GST No.</label>
                                                            <input type="text" id="eventInput6" class="form-control" placeholder="Enter GST No." name="client_gst_no">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" id="eventInput7" class="form-control" name="client_logo" placeholder="" accept=".png,.jpg,.jpeg">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
