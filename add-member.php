...
<?php 
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Add Member</h3>
        </div>
        <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right">
                        <a href="members-list.php" class="btn btn-success mb-1" >View All Members</a>
                    </div>
                </div>
    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                       <form id="add_member_form" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="eventInput1" class="form-control" placeholder="Enter name" name="member_FirstLastname" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="eventInput8">Address<span style="color:red; font-size:20px;">*</span></label>
                                                            <input type="text" id="eventInput8" class="form-control" placeholder="Enter Address" name="member_address" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" id="eventInput2" class="form-control" placeholder="Enter Email Id" name="member_email">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput3">Phone No.<span style="color:red; font-size:20px;">*</span></label>
                                                            <input type="text" id="eventInput3" class="form-control" placeholder="Enter Phone Number" name="member_phone_number" pattern="[6789][0-9]{9}" required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="eventInput4">Designation</label>
                                                            <input type="text" id="eventInput4" class="form-control" placeholder="Enter Designation" name="member_designation">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" id="eventInput5" class="form-control" name="member_photo" placeholder="" accept=".png,.jpg,.jpeg">
                                                        </div>
