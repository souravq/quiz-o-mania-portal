...
<head>
    ...
    <title>Register with Background Color -  - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <div class="card-content">
                                    ...
                                    <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1"><span>OR Using
                                            Email</span></p>
                                    <div class="card-body">
                                        <form class="form-horizontal" action="dashboard.html" novalidate>
