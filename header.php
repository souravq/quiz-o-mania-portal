        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item mr-auto"><a class="navbar-brand" href="dashboard.php"><img class=" priya-logo" alt=" logo" src="app-assets/images/logo/quizomania_logo.png">
                        </a></li>
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700"><?php
                       if($_SESSION['role_value']==1){
                           $sqll=$obj->select_all_where('login_data','where login_id="'.$_SESSION['user_login_id'].'"');
                           foreach($sqll as $valuee){
                            $name=$valuee['login_username'];
                            $name.=" (Treasurer)";
                        }
                       }else{
                        $sqll=$obj->select_all_where('users','where login_data_id ="'.$_SESSION['user_login_id'].'"');
                        foreach($sqll as $valuee){
                            $name=$valuee['user_name'];
                            $name.=" (Collectors)";
                        }
                        ...
                        ?></span><span class="avatar avatar-online"><img src="app-assets/images/portrait/small/profilepic.png" alt="avatar"><i></i></span></a>
