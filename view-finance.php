    ...
    <div class="app-content content">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">View all Finance</h3>
            </div>
            <div class="content-header-right col-md-6 col-12">
                        <div class="btn-group float-md-right">
                            <a href="finance.php" class="btn btn-info mb-1" >View all Finance </a>
                        </div>
                    </div>
        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered dom-jQuery-events">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $sql=$obj->select_all_where('transaction','where user_login_id="'.$user_id.'"');
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td> <?php echo $value['transaction_pay_mode']; ?></td>
                                                           ...
                                                           <?php 
                                                                ...
                                                                if($status==0){
                                                                   ?>
                                                                    <a class="badge badge-danger label-square" onclick="statuschangeall(<?= $value['transaction_id']; ?>,'transaction','1','transaction_id')"><span style="color:white;">Not Approved</span></a>
                                                                <?php }else if($status==1){
                                                                    ?>
                                                                    <a class="badge badge-success label-square" onclick="statuschangeall(<?= $value['transaction_id']; ?>,'transaction','0','transaction_id')"><span style="color:white;">Approved</span></a>
                                                              <?php
                                                                }
                                                                else{
                                                                    echo ' ';
