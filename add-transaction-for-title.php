...
<?php 
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Transaction For Title</h3>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                       <form id="add_transaction_for_title_form">
                                            <div class="row justify-content-md-center">
                                                <div class="col-md-6">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label for="eventInput1"> Transaction For Title<span style="color:red; font-size:20px;">*</span></label>
                                                            <input type="text" id="eventInput1" class="form-control" placeholder="Enter Transaction For Title" name="transaction_for_title" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <!-- END: Page JS-->
     ...
     <script type="text/javascript" src="include/core.js"></script>
      <!--<script type="text/javascript" src="include/core.js?v=1.0.1"></script>-->
      <script type="text/javascript">
//   var script = document.createElement('script');
//   script.src = "include/core.js?v=" + new Date().getTime();
